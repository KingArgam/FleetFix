          ...
          <main className="main-content sidebar-open">
            <Routes>
              ...
              <Route 
                path="/trucks" 
                element={
                  <PageErrorBoundary pageName="Trucks">
                    <EnhancedTrucksPage />
                  </PageErrorBoundary>
                } 
              />
              <Route 
                path="/trucks/:truckId" 
                element={
                  <PageErrorBoundary pageName="Truck Details">
                    <TruckDetailView />
                  </PageErrorBoundary>
                } 
              />
              ...
              <Route 
                path="/parts" 
                element={
                  <PageErrorBoundary pageName="Parts">
                    <PartsPage />
                  </PageErrorBoundary>
                } 
              />
              ...
              <Route 
                path="/downtime" 
                element={
                  <PageErrorBoundary pageName="Downtime Records">
                    <DowntimeRecordsPage />
                  </PageErrorBoundary>
                } 
              />
              <Route 
                ...
                element={
                  <PageErrorBoundary pageName="Recurring Maintenance">
              ...
              <Route 
                path="/bulk-manager" 
                element={
                  <PageErrorBoundary pageName="Bulk Vehicle Manager">
                    <BulkVehicleManager />
                  </PageErrorBoundary>
                } 
              />
              <Route 
                path="/suppliers" 
                element={
                  <PageErrorBoundary pageName="Supplier Manager">
                    <SupplierManager />
                  </PageErrorBoundary>
                } 
              />
